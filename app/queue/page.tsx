    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        ...
        <div className="lg:col-span-2 flex flex-col gap-6">
          <div className="bg-zinc-900/20 border border-white/5 p-6 rounded-3xl backdrop-blur-sm">
              ...
              <div className="space-y-2">
                {executionResult.results.map((r, i) => (
                  <div key={i} className={cn(
                    "flex items-center justify-between border border-white/5 px-4 py-3 text-sm rounded-xl shadow-sm",
          ...
          {queue.length > 0 && (
            <div className="px-1">
              {!showConfirm ? (
                ...
                <div className="bg-amber-500/5 border border-amber-500/20 p-6 rounded-3xl shadow-xl backdrop-blur-sm">
                  ...
                  <div className="flex gap-3">
                    <button onClick={handleExecute} disabled={executing}
                      className="flex-1 bg-emerald-600 px-6 py-3 text-sm font-bold text-white hover:bg-emerald-500 shadow-lg shadow-emerald-600/20 transition-all rounded-xl">
                      {executing ? 'Processing...' : 'Confirm Submission'}
                    </button>
                    <button onClick={() => setShowConfirm(false)}
                      className="flex-1 border border-zinc-800 bg-zinc-900 px-6 py-3 text-sm font-bold text-zinc-400 hover:text-white transition-all rounded-xl">
                      Abort Request
                    </button>
                  </div>
                </div>
        ...
        <div className="bg-zinc-900/20 border border-white/5 p-6 rounded-3xl backdrop-blur-sm self-start">
