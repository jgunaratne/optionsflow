  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="border-b border-white/5 pb-6">
        <h1 className="text-3xl font-bold tracking-tight text-white flex items-center gap-5">
                  ...
                  rows.map((row, i) => (
                    ...
                    >
                      {columns.map(col => (
                        <td
                          key={col.name}
                          className="px-4 py-2.5 text-zinc-300 whitespace-nowrap max-w-[300px] truncate font-mono text-sm"
